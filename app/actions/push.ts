...
export async function subscribeAction(subscription: {
  ...
  // Ciblé sur le SEUL appareil qui vient de s'abonner (pas tous les abonnements du
  // user) : ses autres appareils ont déjà reçu les rappels normaux → pas de doublon.
  try {
    if (isPushConfigured()) {
