    ...
    <Card>
      ...
      <ul className="mt-3 flex flex-col">
        {sessions.map((session, index) => {
          ...
          const labelKey = SESSION_LABEL_KEY[session.type];
          return (
            <li
            ...
            >
              <span className="text-sm font-medium text-foreground">
                {labelKey ? t(labelKey) : session.type}
              </span>
