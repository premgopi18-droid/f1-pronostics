...
export const iconButtonVariants = cva(
  "flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-card pressable hover:bg-secondary/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      tone: {
